        ...
        <div class="col-md-8">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <p class="text-uppercase text-sm">Study Case : {{ $studyCase['case_name'] }}</p>
                  <div class="row">
                    <div class="col">
                      <table class="table">
                        <thead>
          ...
          <div class="row mt-4">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <p class="text-uppercase text-sm">List Alternatif (Nama-nama guru)</p>
                  <form action="{{ route('criteriapair.index') }}" method="POST">
                    @csrf
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" name="idAlternative[]" value="{{ $item->id }}" />
                                  <label class="form-check-label" for="flexCheckChecked">
                                  </label>
                                </div>
                              </td>
                              <td>{{ $item->teacherDetail->school->name ?? "" }}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('criteria.store') }}">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan nama studi kasus" name="criteria_name" required>
                  </div>
