...
class CalculationService
{
  ...
  public function setMatrixCriteria($matrix)
  {
    $this->matrix = $matrix;
  ...
  public function setSumColumnCriteria()
  {
    /**
     * STEP 1
  ...
  public function setNewMatrixCriteria()
  {
    /**
     * STEP 2
  ...
  public function setCriteriaPriority()
  {
    /**
     * STEP 3
  ...
  public function setLamdaCriteria()
  {
    $lamdaCriteria = 0;
    for ($i = 0; $i < ($this->rowLength); $i++) {
  ...
  public function setSubPriorityValue()
  {

    $subPriority = [];
    for ($i = 0; $i < sizeof($this->criteriaPriority); $i++) {
      array_push($subPriority, $this->criteriaPriority[$i] / max($this->criteriaPriority));
    }
